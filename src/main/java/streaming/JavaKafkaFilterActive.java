...
public class JavaKafkaFilterActive {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairDStream<String ,String> listStream = lines.flatMapToPair(new PairFlatMapFunction<String, String, String>() {
            @Override
        ...
        JavaMapWithStateDStream<Tuple2<String, String>, Integer, Integer,
                Tuple2<Tuple2<String ,String>, Integer>>
                activeStream = listStream.filter(new Function<Tuple2<String, String>, Boolean>() {
            @Override
